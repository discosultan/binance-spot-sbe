...
pub use decoder::GroupSize8EncodingDecoder;
pub use encoder::GroupSize8EncodingEncoder;
...
pub mod encoder {
    ...
    pub struct GroupSize8EncodingEncoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> Writer<'a> for GroupSize8EncodingEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> GroupSize8EncodingEncoder<P>
    where
        P: Writer<'a> + Default,
    {
...
pub mod decoder {
    ...
    #[derive(Debug, Default)]
    pub struct GroupSize8EncodingDecoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> ActingVersion for GroupSize8EncodingDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for GroupSize8EncodingDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> GroupSize8EncodingDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        pub fn wrap(mut self, parent: P, offset: usize) -> Self {
