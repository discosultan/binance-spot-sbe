...
pub mod encoder {
    ...
    impl<'a> AccountResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn commission_rate_maker(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn commission_rate_taker(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn commission_rate_buyer(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn commission_rate_seller(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn can_trade(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn can_withdraw(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn can_deposit(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn brokered(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn require_self_trade_prevention(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn prevent_sor(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn update_time(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn account_type(&mut self, value: account_type::AccountType) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn uid(&mut self, value: i64) -> &mut Self {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// - version: 0
        #[inline]
        pub fn free(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 1;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn locked(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 9;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }
        ...
        #[inline]
        pub fn asset(&mut self, value: &str) -> &mut Self {
