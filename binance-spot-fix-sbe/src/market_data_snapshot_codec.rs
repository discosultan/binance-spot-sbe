...
pub use decoder::MarketDataSnapshotDecoder;
pub use encoder::MarketDataSnapshotEncoder;
...
pub mod encoder {
    ...
    pub struct MarketDataSnapshotEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MarketDataSnapshotEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MarketDataSnapshotEncoder<'a> {
        #[inline]
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.last_book_update_id_opt(None);
            self
        }
    }

    impl<'a> MarketDataSnapshotEncoder<'a> {
        ...
        /// optional primitive field 'LastBookUpdateID'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn last_book_update_id_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.last_book_update_id(value),
                None => self.last_book_update_id(-9223372036854775808_i64),
            };
            self
        }
...
pub mod decoder {
    ...
    pub struct MarketDataSnapshotDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MarketDataSnapshotDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MarketDataSnapshotDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MarketDataSnapshotDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MarketDataSnapshotDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        #[inline]
        pub fn last_book_update_id(&self) -> Option<i64> {
