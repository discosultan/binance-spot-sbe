...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for WebSocketSessionStatusResponseEncoder<'a> {
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.authorized_since_opt(None);
            self.user_data_stream_opt(None);
            self
        }
    }
    ...
    impl<'a> WebSocketSessionStatusResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn authorized_since(&mut self, value: i64) -> &mut Self {
            let offset = self.offset;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'authorizedSince'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn authorized_since_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.authorized_since(value),
                None => self.authorized_since(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn connected_since(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn return_rate_limits(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn server_time(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn user_data_stream(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
            let offset = self.offset + 25;
            self.get_buf_mut().put_u8_at(offset, value as u8);
            self
        }

        /// optional enum field 'userDataStream'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn user_data_stream_opt(&mut self, value: Option<bool_enum::BoolEnum>) -> &mut Self {
            match value {
                Some(value) => self.user_data_stream(value),
                None => self.user_data_stream(bool_enum::BoolEnum::NullVal),
            };
            self
        }
        ...
        #[inline]
        pub fn logged_on_api_key(&mut self, value: &str) -> &mut Self {
