...
pub mod encoder {
    ...
    impl<'a> AveragePriceResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn mins(&mut self, value: i64) -> &mut Self {
        ...
        /// optional primitive field 'closeTime'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn close_time_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.close_time(value),
                None => self.close_time(-9223372036854775808_i64),
            };
            self
        }
    }
