...
pub use decoder::LimitQueryDecoder;
pub use encoder::LimitQueryEncoder;
...
pub mod encoder {
    ...
    pub struct LimitQueryEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for LimitQueryEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for LimitQueryEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct LimitQueryDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for LimitQueryDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for LimitQueryDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for LimitQueryDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
