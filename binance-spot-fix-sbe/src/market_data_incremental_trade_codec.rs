...
pub use decoder::MarketDataIncrementalTradeDecoder;
pub use encoder::MarketDataIncrementalTradeEncoder;
...
pub mod encoder {
    ...
    pub struct MarketDataIncrementalTradeEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MarketDataIncrementalTradeEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MarketDataIncrementalTradeEncoder<'a> {
        #[inline]
    ...
    impl<'a> MarketDataIncrementalTradeEncoder<'a> {
        ...
        #[inline]
        pub fn md_entries_encoder(
            self,
            count: u32,
            md_entries_encoder: MDEntriesEncoder<Self>,
        ) -> MDEntriesEncoder<Self> {
            md_entries_encoder.wrap(self, count)
        }
    ...
    impl<'a, P> Writer<'a> for MDEntriesEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for MDEntriesEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.aggressor_side_opt(None);
            self
        }
    }

    impl<'a, P> MDEntriesEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
        ...
        /// optional enum field 'AggressorSide'
        /// - min value: 32
        /// - max value: 126
        /// - null value: 0_u8
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn aggressor_side_opt(&mut self, value: Option<side::Side>) -> &mut Self {
            match value {
                Some(value) => self.aggressor_side(value),
                None => self.aggressor_side(side::Side::NullVal),
            };
            self
        }
    }
...
pub mod decoder {
    ...
    pub struct MarketDataIncrementalTradeDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MarketDataIncrementalTradeDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MarketDataIncrementalTradeDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MarketDataIncrementalTradeDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MarketDataIncrementalTradeDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        #[inline]
        pub fn md_entries_decoder(self) -> MDEntriesDecoder<Self> {
            MDEntriesDecoder::default().wrap(self)
        }
    ...
    impl<'a, P> ActingVersion for MDEntriesDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for MDEntriesDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for MDEntriesDecoder<P>
    where
        ...
        P: Decoder<'a> + ActingVersion + Default,
    {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='MDEntries', referencedName='null', description='null', packageName='null', id=268, version=0, deprecated=0, encodedLength=25, offset=10, componentTokenCount=22, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
