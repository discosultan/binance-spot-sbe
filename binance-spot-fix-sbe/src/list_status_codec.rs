...
pub use decoder::ListStatusDecoder;
pub use encoder::ListStatusEncoder;
...
pub mod encoder {
    ...
    pub struct ListStatusEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ListStatusEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ListStatusEncoder<'a> {
        #[inline]
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            ...
            self.contingency_type_opt(None);
            self.list_reject_reason_opt(None);
            self.transact_time_opt(None);
            self
        }
    }

    impl<'a> ListStatusEncoder<'a> {
        ...
        /// optional enum field 'ContingencyType'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn contingency_type_opt(
            &mut self,
            value: Option<contingency_type::ContingencyType>,
        ) -> &mut Self {
            match value {
                Some(value) => self.contingency_type(value),
                None => self.contingency_type(contingency_type::ContingencyType::NullVal),
            };
            self
        }
        ...
        /// REQUIRED enum
        #[inline]
        pub fn list_status_type(&mut self, value: list_status_type::ListStatusType) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn list_order_status(
            &mut self,
            value: list_order_status::ListOrderStatus,
        ) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn list_reject_reason(
            &mut self,
            value: list_reject_reason::ListRejectReason,
        ) -> &mut Self {
        ...
        /// optional enum field 'ListRejectReason'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn list_reject_reason_opt(
            &mut self,
            value: Option<list_reject_reason::ListRejectReason>,
        ) -> &mut Self {
            match value {
                Some(value) => self.list_reject_reason(value),
                None => self.list_reject_reason(list_reject_reason::ListRejectReason::NullVal),
            };
            self
        }
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn orig_cl_list_id(&mut self, value: &str) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u8::MAX - 1) as usize);
            self.set_limit(limit + 1 + data_length);
            self.get_buf_mut().put_u8_at(limit, data_length as u8);
...
pub mod decoder {
    ...
    pub struct ListStatusDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for ListStatusDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ListStatusDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ListStatusDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ListStatusDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn list_reject_reason(&self) -> list_reject_reason::ListRejectReason {
        ...
        /// VAR_DATA DECODER - character encoding: 'UTF-8'
        #[inline]
        pub fn orig_cl_list_id_decoder(&mut self) -> (usize, usize) {
            let offset = self.get_limit();
            let data_length = self.get_buf().get_u8_at(offset) as usize;
            self.set_limit(offset + 1 + data_length);
            (offset + 1, data_length)
        ...
        #[inline]
        pub fn orig_cl_list_id_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
            debug_assert!(self.get_limit() >= coordinates.0 + coordinates.1);
            self.get_buf().get_slice_at(coordinates.0, coordinates.1)
        }
    }
        ...
        P: Decoder<'a> + ActingVersion + Default,
    {
        ...
        pub fn error_code(&self) -> Option<i32> {
            let value = self.get_buf().get_i32_at(self.offset + 9);
        ...
        P: Decoder<'a> + ActingVersion + Default,
    {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='ListTriggeringInstructions', referencedName='null', description='null', packageName='null', id=25010, version=0, deprecated=0, encodedLength=3, offset=13, componentTokenCount=24, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
