...
pub use decoder::MarketDataIncrementalDepthDecoder;
pub use encoder::MarketDataIncrementalDepthEncoder;
...
pub mod encoder {
    ...
    pub struct MarketDataIncrementalDepthEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MarketDataIncrementalDepthEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MarketDataIncrementalDepthEncoder<'a> {
        #[inline]
    ...
    impl<'a> MarketDataIncrementalDepthEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn first_book_update_id(&mut self, value: i64) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct MarketDataIncrementalDepthDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MarketDataIncrementalDepthDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MarketDataIncrementalDepthDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MarketDataIncrementalDepthDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MarketDataIncrementalDepthDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        P: Decoder<'a> + ActingVersion + Default,
    {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='MDEntriesBids', referencedName='null', description='null', packageName='null', id=25047, version=0, deprecated=0, encodedLength=16, offset=18, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
