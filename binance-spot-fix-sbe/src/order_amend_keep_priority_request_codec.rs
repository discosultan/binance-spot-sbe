...
pub use decoder::OrderAmendKeepPriorityRequestDecoder;
pub use encoder::OrderAmendKeepPriorityRequestEncoder;
...
pub mod encoder {
    ...
    pub struct OrderAmendKeepPriorityRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OrderAmendKeepPriorityRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OrderAmendKeepPriorityRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> OrderAmendKeepPriorityRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct OrderAmendKeepPriorityRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for OrderAmendKeepPriorityRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OrderAmendKeepPriorityRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OrderAmendKeepPriorityRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OrderAmendKeepPriorityRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
