...
pub use decoder::NewsDecoder;
pub use encoder::NewsEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 20100;
...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for NewsEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for NewsEncoder<'a> {
        #[inline]
    ...
    impl<'a> NewsEncoder<'a> {
        ...
        #[inline]
        pub fn headline(&mut self, value: &str) -> &mut Self {
...
pub mod decoder {
    ...
    impl ActingVersion for NewsDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for NewsDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for NewsDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
