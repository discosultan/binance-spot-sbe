...
pub use decoder::OrderMassCancelReportDecoder;
pub use encoder::OrderMassCancelReportEncoder;
...
pub mod encoder {
    ...
    pub struct OrderMassCancelReportEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OrderMassCancelReportEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OrderMassCancelReportEncoder<'a> {
        #[inline]
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.mass_cancel_reject_reason_opt(None);
            self.total_affected_orders_opt(None);
            self.error_code_opt(None);
            self
        }
    }

    impl<'a> OrderMassCancelReportEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn mass_cancel_request_type(
            &mut self,
            value: mass_cancel_request_type::MassCancelRequestType,
        ) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn mass_cancel_response(
            &mut self,
            value: mass_cancel_response::MassCancelResponse,
        ) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn mass_cancel_reject_reason(
            &mut self,
            value: mass_cancel_reject_reason::MassCancelRejectReason,
        ) -> &mut Self {
        ...
        /// optional enum field 'MassCancelRejectReason'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        ...
        #[inline]
        pub fn mass_cancel_reject_reason_opt(
            &mut self,
            value: Option<mass_cancel_reject_reason::MassCancelRejectReason>,
        ) -> &mut Self {
            match value {
                Some(value) => self.mass_cancel_reject_reason(value),
                None => self.mass_cancel_reject_reason(
                    mass_cancel_reject_reason::MassCancelRejectReason::NullVal,
                ),
            };
            self
        }

        /// primitive field 'TotalAffectedOrders'
        ...
        /// - version: 0
        #[inline]
        pub fn total_affected_orders(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 3;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'TotalAffectedOrders'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn total_affected_orders_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.total_affected_orders(value),
                None => self.total_affected_orders(-9223372036854775808_i64),
            };
            self
        }
...
pub mod decoder {
    ...
    pub struct OrderMassCancelReportDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for OrderMassCancelReportDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OrderMassCancelReportDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OrderMassCancelReportDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OrderMassCancelReportDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn mass_cancel_request_type(&self) -> mass_cancel_request_type::MassCancelRequestType {
            self.get_buf().get_u8_at(self.offset).into()
        }

        /// REQUIRED enum
        #[inline]
        pub fn mass_cancel_response(&self) -> mass_cancel_response::MassCancelResponse {
        ...
        pub fn mass_cancel_reject_reason(
            &self,
        ) -> mass_cancel_reject_reason::MassCancelRejectReason {
            self.get_buf().get_u8_at(self.offset + 2).into()
        }

        /// primitive field - 'OPTIONAL' { null_value: '-9223372036854775808_i64' }
        #[inline]
        pub fn total_affected_orders(&self) -> Option<i64> {
            let value = self.get_buf().get_i64_at(self.offset + 3);
        ...
        pub fn error_code(&self) -> Option<i32> {
            let value = self.get_buf().get_i32_at(self.offset + 11);
