...
pub use decoder::InstrumentListRequestDecoder;
pub use encoder::InstrumentListRequestEncoder;
...
pub mod encoder {
    ...
    pub struct InstrumentListRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for InstrumentListRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for InstrumentListRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> InstrumentListRequestEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn instrument_list_request_type(
            &mut self,
            value: instrument_list_request_type::InstrumentListRequestType,
        ) -> &mut Self {
...
pub mod decoder {
    ...
    pub struct InstrumentListRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for InstrumentListRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for InstrumentListRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for InstrumentListRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> InstrumentListRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn instrument_list_request_type(
            &self,
        ) -> instrument_list_request_type::InstrumentListRequestType {
