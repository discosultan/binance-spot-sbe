...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for ErrorResponseEncoder<'a> {
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.server_time_opt(None);
            self.retry_after_opt(None);
            self
        }
    }
    ...
    impl<'a> ErrorResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn code(&mut self, value: i16) -> &mut Self {
        ...
        /// optional primitive field 'serverTime'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn server_time_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.server_time(value),
                None => self.server_time(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn retry_after(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 10;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'retryAfter'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn retry_after_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.retry_after(value),
                None => self.retry_after(-9223372036854775808_i64),
            };
            self
        }
        ...
        #[inline]
        pub fn msg(&mut self, value: &str) -> &mut Self {
