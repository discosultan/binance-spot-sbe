...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for AllocationReportEventEncoder<'a> {
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.source_order_list_id_opt(None);
            self.source_trade_id_opt(None);
            self.source_allocation_id_opt(None);
    ...
    impl<'a> AllocationReportEventEncoder<'a> {
        ...
        pub fn allocation_status(
            &mut self,
            value: allocation_status::AllocationStatus,
        ) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn counter_party_role(
            &mut self,
            value: counter_party_role::CounterPartyRole,
        ) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn counter_party_external_account_id(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn counter_party_order_id(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn allocation_report_id(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn allocation_id(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn source_order_id(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn source_order_list_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 64;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'sourceOrderListId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn source_order_list_id_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.source_order_list_id(value),
                None => self.source_order_list_id(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn source_trade_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 72;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'sourceTradeId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn source_trade_id_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.source_trade_id(value),
                None => self.source_trade_id(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn source_allocation_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 80;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'sourceAllocationId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn source_allocation_id_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.source_allocation_id(value),
                None => self.source_allocation_id(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn source_symbol(&mut self, value: &str) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u8::MAX - 1) as usize);
            self.set_limit(limit + 1 + data_length);
            self.get_buf_mut().put_u8_at(limit, data_length as u8);
