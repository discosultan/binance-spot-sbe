...
pub mod encoder {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// optional primitive field 'commissionExponent'
        /// - min value: -127
        /// - max value: 127
        /// - null value: -128_i8
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn commission_exponent_opt(&mut self, value: Option<i8>) -> &mut Self {
            match value {
                Some(value) => self.commission_exponent(value),
                None => self.commission_exponent(-128_i8),
            };
            self
        }
        ...
        /// REQUIRED enum
        #[inline]
        pub fn allocation_type(&mut self, value: allocation_type::AllocationType) -> &mut Self {
        ...
        /// optional primitive field 'commission'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn commission_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.commission(value),
                None => self.commission(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_buyer(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_allocator(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
