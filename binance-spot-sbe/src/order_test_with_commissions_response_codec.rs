...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for OrderTestWithCommissionsResponseEncoder<'a> {
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.special_commission_for_order_maker_opt(None);
            self.special_commission_for_order_taker_opt(None);
            self
        }
    }
    ...
    impl<'a> OrderTestWithCommissionsResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn standard_commission_for_order_maker(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn standard_commission_for_order_taker(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn tax_commission_for_order_maker(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn tax_commission_for_order_taker(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 1
        #[inline]
        pub fn special_commission_for_order_maker(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 44;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'specialCommissionForOrderMaker'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn special_commission_for_order_maker_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.special_commission_for_order_maker(value),
                None => self.special_commission_for_order_maker(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 1
        #[inline]
        pub fn special_commission_for_order_taker(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 52;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'specialCommissionForOrderTaker'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn special_commission_for_order_taker_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.special_commission_for_order_taker(value),
                None => self.special_commission_for_order_taker(-9223372036854775808_i64),
            };
            self
        }
