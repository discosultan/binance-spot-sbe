...
pub mod encoder {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn rate_limit_type(&mut self, value: rate_limit_type::RateLimitType) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn interval(&mut self, value: rate_limit_interval::RateLimitInterval) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn interval_num(&mut self, value: u8) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn rate_limit(&mut self, value: i64) -> &mut Self {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        #[inline]
        pub fn filter(&mut self, value: &[u8]) -> &mut Self {
            ...
            self.get_buf_mut()
                .put_slice_at(limit + 1, &value[0..data_length]);
            self
        }
    }
        ...
        P: Encoder<'a> + Default,
    {
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.peg_instructions_allowed_opt(None);
            self
        }
    }
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn status(&mut self, value: symbol_status::SymbolStatus) -> &mut Self {
            let offset = self.offset;
            self.get_buf_mut().put_u8_at(offset, value as u8);
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn base_asset_precision(&mut self, value: u8) -> &mut Self {
            let offset = self.offset + 1;
            self.get_buf_mut().put_u8_at(offset, value);
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn quote_asset_precision(&mut self, value: u8) -> &mut Self {
            let offset = self.offset + 2;
            self.get_buf_mut().put_u8_at(offset, value);
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn base_commission_precision(&mut self, value: u8) -> &mut Self {
            let offset = self.offset + 3;
            self.get_buf_mut().put_u8_at(offset, value);
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn quote_commission_precision(&mut self, value: u8) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn iceberg_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn oco_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn oto_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn quote_order_qty_market_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn allow_trailing_stop(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn cancel_replace_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn amend_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_spot_trading_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_margin_trading_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn peg_instructions_allowed(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
            let offset = self.offset + 18;
            self.get_buf_mut().put_u8_at(offset, value as u8);
            self
        }

        /// optional enum field 'pegInstructionsAllowed'
        /// - min value: 0
        /// - max value: 254
        /// - null value: 0xff_u8
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn peg_instructions_allowed_opt(
            &mut self,
            value: Option<bool_enum::BoolEnum>,
        ) -> &mut Self {
            match value {
                Some(value) => self.peg_instructions_allowed(value),
                None => self.peg_instructions_allowed(bool_enum::BoolEnum::NullVal),
            };
            self
        }
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn base_asset(&mut self, value: &str) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u8::MAX - 1) as usize);
            self.set_limit(limit + 1 + data_length);
            self.get_buf_mut().put_u8_at(limit, data_length as u8);
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn quote_asset(&mut self, value: &str) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u8::MAX - 1) as usize);
            self.set_limit(limit + 1 + data_length);
            self.get_buf_mut().put_u8_at(limit, data_length as u8);
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn permission(&mut self, value: &str) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u8::MAX - 1) as usize);
            self.set_limit(limit + 1 + data_length);
            self.get_buf_mut().put_u8_at(limit, data_length as u8);
