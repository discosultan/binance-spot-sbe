...
pub mod encoder {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// - version: 0
        #[inline]
        pub fn agg_trade_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset;
        ...
        /// - version: 0
        #[inline]
        pub fn first_trade_id(&mut self, value: i64) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn last_trade_id(&mut self, value: i64) -> &mut Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn is_buyer_maker(&mut self, value: bool_enum::BoolEnum) -> &mut Self {
