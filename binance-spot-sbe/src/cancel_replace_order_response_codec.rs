...
pub mod encoder {
    ...
    impl<'a> CancelReplaceOrderResponseEncoder<'a> {
        ...
        pub fn cancel_result(
            &mut self,
            value: cancel_replace_status::CancelReplaceStatus,
        ) -> &mut Self {
        ...
        #[inline]
        pub fn cancel_response(&mut self, value: &[u8]) -> &mut Self {
        ...
        /// VAR_DATA ENCODER - character encoding: 'None'
        #[inline]
        pub fn new_order_response(&mut self, value: &[u8]) -> &mut Self {
            let limit = self.get_limit();
