...
pub mod encoder {
    ...
    impl<'a> ReferencePriceResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn reference_price(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 1;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'referencePrice'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn reference_price_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.reference_price(value),
                None => self.reference_price(-9223372036854775808_i64),
            };
            self
        }
