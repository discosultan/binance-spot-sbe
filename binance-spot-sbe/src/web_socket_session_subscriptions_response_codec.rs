...
pub mod encoder {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// - version: 0
        #[inline]
        pub fn expiration_time(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 2;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'expirationTime'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn expiration_time_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.expiration_time(value),
                None => self.expiration_time(-9223372036854775808_i64),
            };
            self
        }
    }
