...
pub mod encoder {
    ...
    impl<'a> BalanceUpdateEventEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn clear_time(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 8;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'clearTime'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn clear_time_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.clear_time(value),
                None => self.clear_time(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn free_qty_delta(&mut self, value: i64) -> &mut Self {
