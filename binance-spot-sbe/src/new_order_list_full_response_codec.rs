...
pub mod encoder {
    ...
    impl<'a> NewOrderListFullResponseEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn transaction_time(&mut self, value: i64) -> &mut Self {
        ...
        #[inline]
        pub fn list_client_order_id(&mut self, value: &str) -> &mut Self {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn status(&mut self, value: order_status::OrderStatus) -> &mut Self {
        ...
        /// optional primitive field 'stopPrice'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn stop_price_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.stop_price(value),
                None => self.stop_price(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn trailing_delta(&mut self, value: i64) -> &mut Self {
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn trailing_delta_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.trailing_delta(value),
                None => self.trailing_delta(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// optional primitive field 'icebergQty'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn iceberg_qty_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.iceberg_qty(value),
                None => self.iceberg_qty(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn prevented_quantity(&mut self, value: i64) -> &mut Self {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        #[inline]
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.maker_order_id_opt(None);
            self.price_opt(None);
            self.taker_prevented_quantity_opt(None);
            self.maker_prevented_quantity_opt(None);
            self
        }
    }
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// - version: 0
        #[inline]
        pub fn maker_order_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 8;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'makerOrderId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn maker_order_id_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.maker_order_id(value),
                None => self.maker_order_id(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn taker_prevented_quantity(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 24;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'takerPreventedQuantity'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn taker_prevented_quantity_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.taker_prevented_quantity(value),
                None => self.taker_prevented_quantity(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn maker_prevented_quantity(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 32;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'makerPreventedQuantity'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn maker_prevented_quantity_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.maker_prevented_quantity(value),
                None => self.maker_prevented_quantity(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// VAR_DATA ENCODER - character encoding: 'UTF-8'
        #[inline]
        pub fn maker_symbol(&mut self, value: &str) -> &mut Self {
            let limit = self.get_limit();
            let data_length = value.len().min((u8::MAX - 1) as usize);
            self.set_limit(limit + 1 + data_length);
            self.get_buf_mut().put_u8_at(limit, data_length as u8);
