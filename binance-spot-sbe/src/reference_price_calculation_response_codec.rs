...
pub mod encoder {
    ...
    impl<'a> Encoder<'a> for ReferencePriceCalculationResponseEncoder<'a> {
        ...
        fn nullify_optional_fields(&mut self) -> &mut Self {
            self.external_calculation_id_opt(None);
            self.bucket_count_opt(None);
            self.bucket_width_ms_opt(None);
            self
        }
    }
    ...
    impl<'a> ReferencePriceCalculationResponseEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn calculation_type(&mut self, value: calculation_type::CalculationType) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn external_calculation_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 1;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// optional primitive field 'externalCalculationId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        #[inline]
        pub fn external_calculation_id_opt(&mut self, value: Option<i64>) -> &mut Self {
            match value {
                Some(value) => self.external_calculation_id(value),
                None => self.external_calculation_id(-9223372036854775808_i64),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn bucket_count(&mut self, value: u32) -> &mut Self {
            let offset = self.offset + 9;
            self.get_buf_mut().put_u32_at(offset, value);
            self
        }

        /// optional primitive field 'bucketCount'
        /// - min value: 0
        /// - max value: 4294967294
        /// - null value: 0xffffffff_u32
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn bucket_count_opt(&mut self, value: Option<u32>) -> &mut Self {
            match value {
                Some(value) => self.bucket_count(value),
                None => self.bucket_count(0xffffffff_u32),
            };
            self
        }
        ...
        /// - version: 0
        #[inline]
        pub fn bucket_width_ms(&mut self, value: u32) -> &mut Self {
            let offset = self.offset + 13;
            self.get_buf_mut().put_u32_at(offset, value);
            self
        }

        /// optional primitive field 'bucketWidthMs'
        /// - min value: 0
        /// - max value: 4294967294
        /// - null value: 0xffffffff_u32
        /// - characterEncoding: null
        ...
        /// Set to `None` to encode the field null value.
        #[inline]
        pub fn bucket_width_ms_opt(&mut self, value: Option<u32>) -> &mut Self {
            match value {
                Some(value) => self.bucket_width_ms(value),
                None => self.bucket_width_ms(0xffffffff_u32),
            };
            self
        }
