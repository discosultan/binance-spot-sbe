...
pub mod encoder {
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// - version: 0
        #[inline]
        pub fn close_price(&mut self, value: i64) -> &mut Self {
        ...
        #[inline]
        pub fn taker_buy_base_volume_at(&mut self, index: usize, value: u8) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn taker_buy_base_volume(&mut self, value: &[u8]) -> &mut Self {
            debug_assert_eq!(16, value.len());
            let offset = self.offset + 88;
            let buf = self.get_buf_mut();
            buf.put_slice_at(offset, value);
        ...
        /// - version: 0
        #[inline]
        pub fn taker_buy_base_volume_from_iter(
            &mut self,
        ...
        /// - version: 0
        #[inline]
        pub fn taker_buy_base_volume_zero_padded(&mut self, value: &[u8]) -> &mut Self {
            let iter = value
                .iter()
                .copied()
                .chain(std::iter::repeat(0_u8))
        ...
        #[inline]
        pub fn taker_buy_quote_volume_at(&mut self, index: usize, value: u8) -> &mut Self {
        ...
        /// - version: 0
        #[inline]
        pub fn taker_buy_quote_volume(&mut self, value: &[u8]) -> &mut Self {
            debug_assert_eq!(16, value.len());
            let offset = self.offset + 104;
            let buf = self.get_buf_mut();
            buf.put_slice_at(offset, value);
        ...
        /// - version: 0
        #[inline]
        pub fn taker_buy_quote_volume_from_iter(
            &mut self,
            iter: impl Iterator<Item = u8>,
        ) -> &mut Self {
            let offset = self.offset + 104;
        ...
        /// - version: 0
        #[inline]
        pub fn taker_buy_quote_volume_zero_padded(&mut self, value: &[u8]) -> &mut Self {
            let iter = value
                .iter()
                .copied()
                .chain(std::iter::repeat(0_u8))
